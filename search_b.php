									...
									?>
										<div class="row">
											...
											<article class="box is-post">
												...
												<form action="search_b.php" name="search" method="post">
														<div class="row">
															<div class="6u">
														...
														if ($inputKeyword=='')
														{
														    $query = 'SELECT * FROM chenlab.miRNA_protein';
														}
														else
														{
														    $query = "SELECT * FROM chenlab.miRNA_protein where miRNA_ID like '%".$inputKeyword."%' "
														 ...
														 <table class="search-result">
															 <tr>
																...
																$gene=$row['gene']; 
																$name=$row['name']; 																
																$miRNA_description  =$row['miRNA_description']; 															
																$mr_function=$row['mr_function']; 															
																$ca_function  =$row['ca_function']; 
																$source  =$row['source']; 
																...
																echo " <td>"  .$mr_function  . " </td>\n";
																
																echo " <td>"  .$ca_function  . " </td>\n";		
