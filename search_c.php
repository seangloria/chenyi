									...
									?>
										<div class="row">
											...
											<article class="box is-post">
												...
												<form action="search_c.php" name="search" method="post">
														<div class="row">
															<div class="6u">
														...
														if ($inputKeyword=='')
														{
														    $query = 'SELECT * FROM chenlab.miRNA_cancer';
														}
														else
														{
														    $query = "SELECT * FROM chenlab.miRNA_cancer where miRNA_ID like '%".$inputKeyword."%' "
