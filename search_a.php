									...
									?>
										<div class="row">
											...
											<article class="box is-post">
												...
												<form action="search_a.php" name="search" method="post">
														<div class="row">
															<div class="6u">
														...
														if ($inputKeyword=='')
														{
														    $query = 'SELECT * FROM chenlab.miRNA_Autophagy';
														}
														else
														{
														    $query = "SELECT * FROM chenlab.miRNA_Autophagy where miRNA_ID like '%".$inputKeyword."%' "
