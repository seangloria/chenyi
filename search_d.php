									...
									?>
										<div class="row">
											...
											<article class="box is-post">
												...
												<form action="search_d.php" name="search" method="post">
														<div class="row">
															<div class="6u">
														...
														if ($inputKeyword=='')
														{
														    $query = 'SELECT * FROM chenlab.autophagy_cancer';
														}
														else
														{
														    $query = "SELECT * FROM chenlab.autophagy_cancer where cancer_name like '%".$inputKeyword."%' "
