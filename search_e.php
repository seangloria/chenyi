									...
									?>
										<div class="row">
											...
											<article class="box is-post">
												...
												<form action="search_e.php" name="search" method="post">
														<div class="row">
															<div class="6u">
														...
														if ($inputKeyword=='')
														{
														    $query = 'SELECT * FROM chenlab.autophagy_protein';
														}
														else
														{
														    $query = "SELECT * FROM chenlab.autophagy_protein where unac like '%".$inputKeyword."%' "
